...
public class HnetMySqlRecordDAO implements IRecordDAO {
    ...
    public HnetMySqlRecordDAO(@NotNull FoodTrackerServerConfig config) {this(config, new HibernateDbExecutor() ,null);}
    public HnetMySqlRecordDAO(@NotNull FoodTrackerServerConfig config, @NotNull IDbExecutor iQueryExecuter,
    ...
    private Collection<Record> getTransactions(String query) {
    ...
    public Record getRecord(int transactionGuid) throws UsersPlatformException {
        ...
        Collection<Record> results = getTransactions(stringQuery);
    ...
    @Override
    public void setRecordFoodType(int transactionGuid, FoodType newFoodType) throws UsersPlatformException, SQLException {
        Record record = getRecord(transactionGuid);
        if(record == null)throw new UsersPlatformException("Transaction {"+transactionGuid+"} was not found");
    ...
    @Override
    public void setRecordUser(int transactionGuid, User newUser) throws UsersPlatformException, SQLException {
        Record record = getRecord(transactionGuid);
        if(record == null)throw new UsersPlatformException("Transaction {"+transactionGuid+"} was not found");
